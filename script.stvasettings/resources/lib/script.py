...
class MyProgressDialog():
    def __init__(self, process):
        ...
        self.dp.create("Instalador Ajustes Recomendados", process, '', 'Espere...')
...
def stvasettings():
    ...
    url = 'https://stvabuild.github.io/packestuarystva.zip'
    ...
    dialog.ok(addon_name, "%s Por favor, cierra la aplicación para completar el proceso. Vuelve a abrir la aplicación y continúa instalando los addons requeridos." % message)
    os._exit(0)
